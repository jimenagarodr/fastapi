...
[![codecov](https://codecov.io/gh/jimenagarodr/fastapi/branch/main/graph/badge.svg?token=fastapi_token_here)](https://codecov.io/gh/jimenagarodr/fastapi)
[![CI](https://github.com/jimenagarodr/fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/jimenagarodr/fastapi/actions/workflows/main.yml)

Awesome fastapi created by jimenagarodr

## Install

from source
```bash
git clone https://github.com/jimenagarodr/fastapi fastapi
cd fastapi
make install
```
